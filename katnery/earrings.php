...
<div class="container mx-auto px-4 py-8">
    ...
    <nav class="breadcrumb-nav text-sm text-gray-500 mb-4">
        <a href="http://localhost/katnery/" class="no-underline text-gray-500">Home</a> &nbsp;/&nbsp; Earrings
    </nav>

    <!-- Page Title -->
    <h1 class="text-5xl font-bold mb-4">Earrings</h1>
    ...
    <div class="product-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div class="product-item text-center" 
            ...
            data-name="Elegant Diamond Earrings" 
            data-price="2200"
            data-images='["/assets/img/earrings-a.jpg", "/assets/img/earrings-b.jpg", "/assets/img/earrings-c.jpg"]'
            data-description="Stunning diamond earrings featuring a unique design that combines elegance and modernity. Perfect for special occasions or everyday wear. Crafted with high-quality materials for durability and shine.">
            <div class="product-image">
                <a href="product.php?name=Elegant%20Diamond%20Earrings&price=2200&description=Stunning%20diamond%20earrings%20featuring%20a%20unique%20design%20that%20combines%20elegance%20and%20modernity.%20Perfect%20for%20special%20occasions%20or%20everyday%20wear.%20Crafted%20with%20high-quality%20materials%20for%20durability%20and%20shine.&images=/assets/img/earrings-a.jpg,/assets/img/earrings-b.jpg,/assets/img/earrings-c.jpg&category=Earring">
                    <img alt="Elegant diamond earrings" src="https://storage.googleapis.com/a1aa/image/earring-example.jpg">
                </a>
                <div class="overlay">
            ...
            <h2 class="text-xl font-semibold">Elegant Diamond Earrings</h2>
